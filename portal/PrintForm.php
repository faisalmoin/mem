  ...
  //  $count = isset($_REQUEST['count']);
    ...
    <tr>
     ...
     <tr>
       <td>12</td>
       <td>Distance to School from Residence (in KM)</td>
	   <td ><span style="color: #001C7E;"><?php echo $rf['Distance'];?></span></td>
	   <td>Mode of Transport <sup style="color: #990000; font-weight: bold">*</sup></td>
	   <td colspan="2"><span style="color: #001C7E;"><?php echo $rf['TransportMode'];?></span></td>
     </tr>
	 <tr>
		<td>13</td>
		<td>Does your child have major ailment/allergy?</td>    
		...
		<td><span style="color: #001C7E;"><?php echo $rf['Physically Remarks'];?></span></td>
	 </tr>
     <tr>
        <td>10</td>
        <td colspan="4">Details of sisters and brothers in chronological order including the applicant (oldest to youngest)
        </td>
     </tr>
     <tr>
        <td></td>
