	...
	<div class="row">
		<div class="col-md-3" style="">
			...
			<b style='font-family: Quicksand, sans-serif; font-weight: bold; font-size: 18px; color: #000000;'>Franchisee Fee</b><hr />
				<div class="row">
					<div class="col-md-8 " style="padding:10px;">Total franchisees </div>
			...
			<div class="col-md-12" style="background-color: #ffffff;padding:10px;border: 1px solid #eaecee;min-height: 500px;">
				...
				<table class="table table-responsive table-bordered">
					...
					<tr>
						...
						<td rowspan="5" style="text-align: center;vertical-align:middle; "><a href="LeadStat.php?z=<?php echo odbc_result($q1, "Region")?>">
						<?php
							//Get State Code
							$stcode = "";
