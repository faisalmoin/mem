...
<div class="table-responsive">
	<table class="table">
		...
		<tr>
			...
			<td>Passport No.</td>
                        <td><input type="text" name="PassportNo" class="form-control" /></td>
		</tr>
		<tr>
			...
			<td><input type="text"name="PassportExpDt" class="form-control" /></td>
		</tr>
		<tr>
			...
			<td>Visa No.</td>
			<td><input type="text" name="VisaNo" class="form-control" /></td>
		</tr>
		<tr>
			...
			<td>Visa Exp. Date</td>
			<td><input type="text"name="VisaExpDt" class="form-control" /></td>
		</tr>
