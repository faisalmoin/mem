...
<script type="text/javascript" charset="utf-8">
	...
	<table class="table">
		...
		<tr>
                    <td>Class</td>
                    <td>
                        <!--select style="background-color: #ffff00;" class="form-control" name="Class" id="class" onChange="changetextbox();" required -->
                           <!--select style="background-color: #ffff00;" class="form-control" name="Class" id="class" onChange="getClass();getClassDiscount();" required -->
