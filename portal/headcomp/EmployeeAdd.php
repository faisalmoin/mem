<?php
	require_once("SetupLeft.php");
		...
		$qryEnq1 = odbc_exec($conn, "SELECT COUNT([No_])+1 FROM [Employee] where [Company Name]='$ms'") or die(odbc_errormsg());
...
//$total = count($_FILES['fileToUpload']['name']);
	...
	//echo "<br /><br />$string<br /><br />";
			...
			//Success Message
			echo "<div class='alert alert-success alert-error'><strong>Success!</strong> Employee has been registered.</div>";
		}
		
		echo "<META http-equiv='refresh' content='0;URL=EmployeeList.php>";//header("Location: NewEnquiry.php?eid=$EnquiryNo");
