		...
		<div class="tab-pane fade in active" id="gen">
				<table class="table table-responsive">                                    
						...
						<td height="50px">Employee Id</td>
                                        ...
                                        <tr>
						<td height="50px">Employee Status</td>
                                                <td height="50px"><select name="Status" required class="form-control">
								<option value=""></option>
								<option <?php if(odbc_result($rs, "Status") == 0) { echo "selected='selected'"; } ?> value="0">InActive</option>
								<option <?php if(odbc_result($rs, "Status") == 1) { echo "selected='selected'"; } ?> value="1">Active</option>
                                                               </select></td></tr>
                                        <tr>
					...
					<tr>
						...
						<td height="50px"><input type="text" name="MidName" value="<?php echo odbc_result($rs, "Middle Name");?>" class="form-control" placeholder="Middle Name" /></td>
					</tr>
					<tr>
					...
					<!--td height="50px">
                     ...
                     <td height="50px" class="ss-item-required"><input type="text" name="DOB" maxlength="16" style="padding: 4px; background-color: #FFFF00; border: 0px solid #E5E4E2;" class="form-control" id="datepicker2" value="<?php echo date('d/M/Y', strtotime(odbc_result($rs, "Birth Date")));?>" onchange="checkDiff(this.value)" required  /></td>
				...
				<td height="50px">Citizenship</td>
                                ...
                                <tr>
                                        ...
                                        <td height="50px"><input type="text" class="form-control" id="date2" name="ctc" value="<?php echo number_format(odbc_result($rs, "CTC"),2,'.','')?>"/><p style="color:red; font-size: 10px;">Only Numbers</p></td>
		...
		<div class="tab-pane fade" id="com">
				...
				<tr>
					<td height="50px">Phone No. (Landline)</td>
                                        <td height="50px"><input type="tel" maxlength="15" class="number-only form-control" value="<?php echo odbc_result($rs, "Phone No_")?>" name="Landline" style="padding: 4px;" /></td>
                                </tr>
                                <tr>
                                        <td height="50px">Mobile No.</td> 
                                        <td height="50px"><input type="text" class="number-only form-control" name="Mobile" value="<?php echo odbc_result($rs, "Mobile Phone No_")?>" maxlength="10" style="padding: 4px;" onblur="if(this.value.length < 10){alert('Mobile number should not be less than 10 digit ...');}" /></td>
				</tr>
				<tr>
				...
				<table class="table table-responsive">
					...
					<tr>
						<td height="50px">Institute/University</td>
                                         ...
                                         <tr><td height="50px">Post Code</td>
                                        <td height="50px">
                                        <input type="text" name="PostCode1" maxlength="6" class="form-control" style="padding: 4px;background-color: #ffff00" id="postcode1" maxlength="6" onblur="if(this.value.length < 6){alert('Post Code must be 6 digit ...');}" onchange="updateCityState1()" value="<?php echo odbc_result($rs, "Qual PostCode")?>" />
                                        </td>
                                        </tr>
                                        
					<tr>
						<td height="50px">Country</td>
                                                <td height="50px"><input type="text" name="Country1" id="country1"  class="form-control" value="<?php echo odbc_result($rs, "Qual Country")?>" /></td>
					</tr>
					<tr>
						<td height="50px">State</td>
                                                <td height="50px"><input type="text" name="State1" id="state1"  class="form-control" value="<?php echo odbc_result($rs, "Qual State")?>" /></td>
					</tr>
					<tr>
						<td height="50px">City</td>
                                                <td height="50px"><input type="text" name="City1" id="city1" class="form-control" value="<?php echo odbc_result($rs, "Qual City")?>" /></td>
					</tr>
					<!--tr>
