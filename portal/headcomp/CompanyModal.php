	...
	<ul id="myTab<?php echo $i?>" class="nav nav-tabs">
		<li class="active"><a href="#gen<?php echo $i?>" data-toggle="tab">General</a></li>
		<li><a href="#com<?php echo $i?>" data-toggle="tab">Communication</a></li>
		<li><a href="#tax<?php echo $i?>" data-toggle="tab">Tax Information</a></li>
		<li><a href="#efil<?php echo $i?>" data-toggle="tab">E-Filling</a></li>
	</ul>

	<div id="myTab<?php echo $i?>" class="tab-content">
		<div class="tab-pane fade in active" id="gen<?php echo $i?>">
				<table class="table table-responsive">
					<tr>
						<td>Name</td>
						<td colspan="2"><?php odbc_result($rs, "Name")?></td>
					</tr>
					<tr>
						<td>Address</td>
		...
		<div class="tab-pane fade" id="com<?php echo $i?>">
				<table class="table table-responsive">
					<tr>
						<td>Phone No.</td>
		...
		<div class="tab-pane fade" id="tax<?php echo $i?>">
				<table class="table table-responsive">
					<tr>
		...
		<div class="tab-pane fade" id="efil<?php echo $i?>">
				<table class="table table-responsive">
					<tr>
						<td>P.A.N. Status</td>
						<td>
