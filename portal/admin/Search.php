...
<div class="container">
	...
	<?php
		...
		$QryEnq = "SELECT * FROM [Temp Enquiry] WHERE (
	...
	<h3 class="text-primary">Enquiry ...</h3>
		<table class="table table-striped table-hover">
			...
			?>
				<tr style="font-size: 12px;">
					<td><?php echo $i?></td>
					<td><?php echo odbc_result($Enq, "Company Name")?></td>
		...
		<?php
			...
			$i=1;
			//Application table
			$QryApp = "SELECT * FROM [Temp Application] WHERE (
				lower([No_]) LIKE lower('%".strtoupper($_REQUEST['AdmNo'])."%') OR 
				lower([Name]) LIKE lower('%".strtoupper($_REQUEST['AdmNo'])."%') OR 
		...
		<table class="table table-striped table-hover">
			...
			?>
				<tr style="font-size: 12px;">
					<td><?php echo $i?></td>
					<td><?php echo odbc_result($App, "Company Name")?></td>
		...
		<?php	
			...
			$i=1;
			//Student Table
			$QryStu = "SELECT * FROM [Temp Student] WHERE 
		...
		<table class="table table-striped table-hover">
			...
			?>
				<tr style="font-size: 12px;">
					<td><?php echo $i; ?></td>
					<td><?php echo odbc_result($Student, "Company Name")?></td>
					<td>
