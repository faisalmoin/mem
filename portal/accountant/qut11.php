<?php   
	...
	// loop started
	 ...
	 <div class="container">
	  ...
	  // loop end
	// echo "<META http-equiv='refresh' content='0;URL=FeeTerm.php'>";
	   echo "<script>
            alert('Fee Generated');
	 ...
	 ?>
	   ...
	   <?php require_once("../footer.php");
			function MonthNo($Mnth,$Reg){
				...
				[Fee Description]='".odbc_result($rs, "Description")."' AND [Year]='".date('Y', $today)."' AND [Month] = '".date('m', $today)."' AND [Qtr] = '$Qtr' ") or die(odbc_errormsg($conn)) ;
