...
<div class="table-responsive" style="width: 40%">
	<table class="table">
		...
		<tr>
			<td>Phone No</td>
			<td><input type="text" maxlength="15" name="PhoneNo" value="<?php echo odbc_result($rs, 'phone number')?>" class="number-only form-control" /></td>
		</tr>
		<tr>
			<td>Mobile</td>
			<td><input type="text" maxlength="10" style="background-color: #ffff00;" name="MobileNo" value="<?php echo odbc_result($rs, 'mobile number')?>" class="number-only form-control" maxlength="13" required /></td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td><input maxlength="10" name="FatherMobile" value="<?php echo odbc_result($rs, 'Father Mobile')?>" class="number-only form-control" /></td>
		</tr>
		<tr>
			<td>Mother Email</td>
		...
		<tr>
			...
			<td><input maxlength="10" name="MotherMobile" value="<?php echo odbc_result($rs, 'Mother Mobile')?>" class="number-only form-control" /></td>
		</tr>
	</table>
</div>