...
<html>
	<head>
		...
		<style type="text/css" media="print">
			...
			opener.location.href = "ReverseInv.php";
			<?php } ?>
			}
		</script>
...
?>
			...
			<tr>
				<td colspan="3" style="border-left: 1px solid #d3d3d3; border-top: 1px solid #d3d3d3; border-bottom: 1px solid #d3d3d3;"><b>TOTAL</b></td>				
					...
					$TotAmt1 = odbc_exec($conn, "SELECT SUM([Amount]) FROM [Ledger Invoice] WHERE [Invoice No]='$inv' AND [Customer No]='$id' AND [Company Name]='$ms' ");
				...
				?>
                                ...
                                <?php
					//Get Amount From Credit
					$TotAmt2 = odbc_exec($conn, "SELECT SUM([Discount Code1 Amount]) FROM [Ledger Invoice] WHERE [Invoice No]='$inv' AND [Customer No]='$id' AND [Company Name]='$ms' ");
