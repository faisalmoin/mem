...
<table id="results2" class="table table-responsive">
	...
	<?php
              ...
              //echo "SELECT * FROM [Temp Student] WHERE [Company Name]='$CompName' AND [No_]='$Admissionno'  ";
		...
		while(odbc_fetch_array($rs)){
                $Check = odbc_exec($conn, "Select DISTINCT([DiscountNo]) FROM [StudentDiscountDetails] where [ApplicationNo]='$Customerno' AND [CompanyName]='$CompName' AND [DocumentNo_]='".odbc_result($rs, "No_")."' ") or die(odbc_errormsg($conn)); 
		?>
	<tr>
