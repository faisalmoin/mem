			...
			if($_SERVER['REQUEST_METHOD'] == 'GET' && $_REQUEST['invoice'] != ""){
				...
				*/
				...
				while(odbc_fetch_array($rs)){
					...
					if(odbc_result($Admissionno, "Registration No_") != NULL){
		?>
		<tr>
			<td><?php echo $i?></td>
			...
			<td><!--a href="GenFeedicountEdit.php?invoice=<?php echo odbc_result($Admissionno, "Registration No_")?>&Class=<?php echo odbc_result($rs, "Class");?>&AdmissionYear=<?php echo odbc_result($rs, "Academic Year");?>"><?php echo odbc_result($rs, "Name");?></a-->
				<a href="ReverseFee.php?invoice=<?php echo odbc_result($Admissionno, "Registration No_")?>&Class=<?php echo odbc_result($rs, "Class");?>&AdmissionYear=<?php echo odbc_result($rs, "Academic Year");?>"><?php echo odbc_result($rs, "Name");?></a>
			</td>
			<td><?php 
