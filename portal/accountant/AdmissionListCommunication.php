...
<div class="table-responsive" style="width: 40%">
	<table class="table">
		...
		<tr>
			<td>Phone No</td>
			<td><input readonly type="text" name="PhoneNo" value="<?=$row['PhoneNo']?>" class="number-only form-control" /></td>
		</tr>
		<tr>
			<td>Mobile</td>
			<td><input readonly type="text" name="MobileNo" value="<?=$row['MobileNo']?>" class="number-only form-control" required /></td>
		</tr>
		<tr>
