...
<script type="text/javascript" charset="utf-8">
    ...
    $(function(){
        ...
        $("#datepicker1").datepicker({minDate: "<?php echo date('d/M/Y', strtotime(odbc_result($rs, "Date of Receive")))?>",maxDate: 0});
	...
	<table class="table">
		...
		<tr>
			<td>Date of Birth</td>
			<td><input type="text" value="<?php echo date('d/M/Y', strtotime(odbc_result($rs, 'Date of Birth'))); ?>" class="form-control" name="DOB" id="datepicker2"  required /></td>
