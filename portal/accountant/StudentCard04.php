...
<table class="table table-responsive">
                <tr>
                    <td>Date Joined</td>
                    <td><input type="text" name="DateJoined" value="<?php echo date('d/M/Y', strtotime(odbc_result($row, "Date Joined")))?>" class="form-control" id="datepicker2"></td>
                    <td>Fee Classification</td>
                    <td><input type="text" readonly="true" value="<?php echo odbc_result($row, "Fee Classification")?>" class="form-control"></td>
                    <!--td>Discount Code</td>
                    <td><input type="text" value="<?php echo odbc_result($row, "Discount Code")?>" class="form-control"></td-->
                </tr>
                <tr>
                    <td>Height</td>
                    <td><input name="Height" type="text" value="<?php echo number_format(odbc_result($row, "Height"),'2','.','')?>" class="form-control"></td>
                    <td>Student Status</td>
                    <!--td><input type="text" value="<?php if(odbc_result($row, "Student Status")==1) echo "Student"; if(odbc_result($row, "Student Status")==2) echo "In-active"; if(odbc_result($row, "Student Status")==3) echo "Alumni"; ?>" class="form-control" ></td-->
                    <td><select name='StudentStatus' class="form-control">
                    <option value='1' <?php if(odbc_result($row, "Student Status")==1) echo " selected"?>>Student</option>
                    <option value='2' <?php if(odbc_result($row, "Student Status")==2) echo " selected"?>>Inactive</option>
                    <option value='3' <?php if(odbc_result($row, "Student Status")==3) echo " selected"?>>Alumni</option>
                    <option value='4' <?php if(odbc_result($row, "Student Status")==4) echo " selected"?>>Withdrawal</option>
                   
                </select></td>
                    <!--td>Discount Classification</td>
                    <td><input type="text" value="<?php echo odbc_result($row, "Discount Classification")?>" class="form-control" ></td-->
                </tr>
                <tr>
                    <td>Weight</td>
                    <td><input name="Weight" type="text" value="<?php echo number_format(odbc_result($row, "Weight"),'2','.','')?>" class="form-control" ></td>
                    <td>Block</td>
                    <td><input type='checkbox' name='Block' value="1" <?php 
                    if(odbc_result($row, "Block")==1)
                    {
                            echo " checked";
                    }
                    ?>></td>
                    ...
                    <td><input type="text" value="<?php echo odbc_result($row, "Discount Code 1")?>" class="form-control" ></td-->
                </tr>
                <tr>
                    <td>Quota</td>
                    <td><input name="Quota" type="text" value="<?php echo odbc_result($row, "Quota")?>" class="form-control" ></td>
                    <td>Admission For Year</td>
                    <td><input name="AdmissionYear" type="text" value="<?php echo odbc_result($row, "Admission For Year") ?>" class="form-control" ></td>
                    <!--td>Discount Classification 1</td>
                    <td><input type="text" value="<?php echo odbc_result($row, "Discount Classification1")?>" class="form-control" ></td-->
                </tr>
                <tr>
                    <td>Staff Child</td>
                     <td><input type='checkbox' name='StaffChild' value="1" <?php 
                    if(odbc_result($row, "Staff Child")==1)
                    {
                            echo " checked";
                    }
                    ?>></td>
                   <td></td>
                    ...
                    <td colspan="3"><input type="checkbox" <?php if(odbc_result($row, "Physically Challenged")==1) echo " checked"; ?>></td-->
                </tr>
                <tr>
                    <td>Staff Code</td>
                    <td><input name="StaffCode" type="text" value="<?php echo odbc_result($row, "Staff Code")?>" class="form-control" ></td>
                    <!--td></td-->
                    <td colspan="2" align="center" style="border-left: 1px solid #d3d3d3;border-right: 1px solid #d3d3d3;"><b>TC Details</b></td>                    
                </tr>
                <tr>
                    <td>Application No</td>
                    <td><input name="ApplicationNo" type="text" value="<?php echo odbc_result($row, "Application No_")?>" class="form-control"></td>
                    <!--td style="border-top: 0px solid #d3d3d3;"></td-->
                    <td style="border-left: 1px solid #d3d3d3;">TC Number</td>
                    <td style="border-right: 1px solid #d3d3d3;"><input type="text" name="TC" value="<?php echo odbc_result($row, "TC No_")?>" class="form-control"></td>
                </tr>
                <tr>
                    <td>Registration No</td>
                    <td><input type="text" readonly="true" name="RegNo" value="<?php echo odbc_result($row, "Registration No_")?>" class="form-control" ></td>
                    <!--td style="border-top: 0px solid #d3d3d3;"></td-->
                    <td style="border-left: 1px solid #d3d3d3;">TC Date</td>
                    <td style="border-right: 1px solid #d3d3d3;"><input name="TCDate" type="text" value="<?php if(odbc_result($row, "TC Date") != "1753-01-01 00:00:00.000") echo date('d/M/Y', strtotime(odbc_result($row, "TC Date")))?>" class="form-control"></td>
                    
                </tr>
                <tr>
                    <td>User ID</td>
                    <td><input type="text" value="<?php echo odbc_result($row, "User ID")?>" class="form-control" ></td>
                    <!--td style="border-top: 0px solid #d3d3d3;"></td-->
                    <td style="border-left: 0px solid #d3d3d3;">Withdrawal Applied Date</td>
                    <td style="border-right: 0px solid #d3d3d3;"><input name="withdrawaldate" type="text" value="<?php if(odbc_result($row, "Withdrwal Applied Date") != "1753-01-01 00:00:00.000") echo date('d/M/Y', strtotime(odbc_result($row, "Withdrwal Applied Date")))?>" class="form-control" ></td>
                    
                </tr>
                <tr>
                    <td>Approver ID</td>
                    <td><input type="text" value="<?php echo odbc_result($row, "Approver ID")?>" class="form-control" ></td>
                </tr>   
                ...
                <tr>
                    ...
                    <td><input type="text" value="<?php echo(odbc_result($row, "Class Code")); ?>" class="form-control" readonly></td>
                    <td></td>
