...
$fid=str_pad($fid1,4,"0",STR_PAD_LEFT);
     ...
     
 {
  ...
  $resultservicetax = odbc_exec($conn, $SQLServiceTAX) or die(odbc_errormsg($conn));
     ...
     $vdritem="select [Item Name] from [VMS Item Master]";
     $resultvdritem = odbc_exec($conn, $vdritem) or die(odbc_errormsg($conn));
      $vdritem1="select [Item Name] from [VMS Item Master]";
              $resultvdritem1 = odbc_exec($conn, $vdritem1) or die(odbc_errormsg($conn));
     ...
     <div class="row">
       ...
       <div class="col-sm-12 col-md-12">
          ...
          ?>
                               ...
                               <div style="overflow-x: auto;overflow-y: scroll,min-height:500px;" >
           ...
           <select  class="selectpicker form-group submenu" data-live-search="true" id="itemname1" name="itemname[]" required=""   onchange="check_s(1);" size="10">
          <option value=""></option>
          <?php
          
            while(odbc_fetch_array($resultvdritem)){?>
              <option value="<?php echo odbc_result($resultvdritem, "Item Name");?>">
                 <?php echo odbc_result($resultvdritem, "Item Name");?>
              </option>
           <?php  }?>
