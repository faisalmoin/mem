         ...
         <div class="row">
           ...
           <div class='col-md-10'>
               ...
               <div class="row">
					                                      ...
					                                      <div class="col-sm-6 col-md-3 class="form-control"">Vendor</div>
                                                <div class="col-sm-6 col-md-3"><input type="text" name="vendor" required="" value="<?php echo odbc_result($result, "Vendor") ?>"/></div>
            ...
            <div class="row"> 
                                               ...
                                               <div class="col-sm-6 col-md-3">Post Code</div>
                                                <div class="col-sm-6 col-md-3"><input type="text" name="postcode" onkeyup="getcitystate();" required="" id="postcode" value="<?php echo odbc_result($result, "Post Code") ?>"/></div>
                                               
            
            </div>
					<div class="row">                                
                                                <div class="col-sm-6 col-md-3">City</div>
                                                <div class="col-sm-6 col-md-3"><input type="text" name="city" id="city" required="" value="<?php echo odbc_result($result, "City") ?>"/></div>
                                                <div class="col-sm-6 col-md-3">State</div>
                                                <div class="col-sm-6 col-md-3"><input type="text" name="state" id="state" required="" value="<?php echo odbc_result($result, "State") ?>"/></div>
                                                </div>
          <div class="row"> 
						                                    <div class="col-sm-6 col-md-3">Country</div>
                                                <div class="col-sm-6 col-md-3"><input type="text" name="country" id="country" required="" value="<?php echo odbc_result($result, "Country") ?>"/></div>
          ...
          <div class="row"> 
                                                ...
                                                <div class="col-sm-6 col-md-3"><input type="text" name="tin"  value="<?php echo odbc_result($result, "TIN") ?>"/></div>
					</div>
          <div class="row"> 
						                                    <div class="col-sm-6 col-md-3">CST Number</div>
                                                <div class="col-sm-6 col-md-3"><input type="text" name="cst"value="<?php echo odbc_result($result, "CST") ?>"/></div>
          ...
          <div class="row"> 
                                                ...
                                                <div class="col-sm-6 col-md-3"><input type="text" name="tan"  value="<?php echo odbc_result($result, "TAN") ?>"/></div>
          ...
          <div class="row"> 
                                                ...
                                                <div class="col-sm-6 col-md-3"><input type="text" name="sme"  value="<?php echo odbc_result($result, "SME") ?>"/></div>
          ...
          <div class="row"> 
                                                ...
                                                <div class="col-sm-6 col-md-3"><input type="text" name="contactpersondetails"  value="<?php echo odbc_result($result, "Contact details") ?>"/></div>
          ...
          <div class="row"> 
                                                ...
                                                <div class="col-sm-6 col-md-3"><input type="text" name="rtgscode"  value="<?php echo odbc_result($result, "RTGS Code")?>"/></div>
                                                <div class="col-sm-6 col-md-3">Remittance Address</div>
                                                <div class="col-sm-6 col-md-3"><input type="text" name="remittanceaddress"  value="<?php echo odbc_result($result, "remittance Address") ?>"/></div>
						</div>
          <div class="row"> 
                                                ...
                                                <div class="col-sm-6 col-md-3">Mobile</div>
                                                <div class="col-sm-6 col-md-3"><input type="text" name="remittancemobile"  value="<?php echo odbc_result($result, "Mobile") ?>"/></div>
						</div>
          <div class="row"> 
