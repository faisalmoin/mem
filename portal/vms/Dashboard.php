            ...
            <div class="col-md-3 col-sm-12 col-xs-12">
                ...
                <div class="col-md-4 col-sm-12 col-xs-12">
                        ...
                        <table class="table table-striped" >
                            ...
                            $EnqStat = odbc_exec($conn, "SELECT COUNT(*) FROM [VMS Vendor Master] ");
                            while(odbc_fetch_array($EnqStat)){
                                ?>
                                <tr>
                                    ...
                                    <td align="center">
                                        <?php
                                        $CntEnqStat = odbc_exec($conn, "SELECT COUNT(*) FROM [VMS Vendor Master]");?>
                ...
                <div class="col-md-5 col-sm-12 col-xs-12">
                        ...
                        <table class="table table-striped" >
                            ...
                            $EnqStat = odbc_exec($conn, "SELECT COUNT(*) FROM [VMS Item Master]");
                            while(odbc_fetch_array($EnqStat)){
                                ?>
                                <tr>
                                    ...
                                    <td align="center">
                                        <?php
                                        $CntEnqStat = odbc_exec($conn, "SELECT COUNT(*) FROM [VMS Item Master] ");?>
