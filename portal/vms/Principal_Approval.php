     ...
     <div class="row">
        <div class="col-md-1"></div>
	      <div class="col-sm-10 col-md-10">
            ...
            <?php }}?>
            <div class="row">
               <input type="button" class="btn btn-primary" value="Director's Approval" onClick="document.location.href='TakeHeadApproval.php'" />
            </div>
		         <div class="row">
                    ...
                    <table>
		             ...
		             <td class="col-sm-1 col-md-1">  <input type="radio" name="reject<?php echo $i; ?>" value="reject" />
                           </td>
