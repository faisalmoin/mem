...
<div class="container">
    <table class="table">
        <tr>            
            <td style="width: 50%; background-color: #ffffff;border: none;" >
            <span style="font-size: 18px;color: #0075c2;" >Franchisee</span>            
            ...
            <td style="width: 50%;border: none;">
                ...
                FusionCharts.ready(function () {
                    var revenueChart = new FusionCharts({
                        ...
                        dataSource: {
                            "chart": {
                                "caption": "Comparison of Quarterly Outstanding",
                                "xAxisname": "Quarter",
        ...
        <tr>
            ...
            <td style="min-height: 400px;border: none;">
