<?php
require_once("../db.txt");
$get_dates1 = odbc_exec($conn, "SELECT * FROM [MemFin Franchisee Credit] ") or die(odbc_errormsg($conn));
//echo "SELECT * FROM [MemFin Franchisee Credit] ";
$Invoice=odbc_result($get_dates1, "Invoice No");
$Amount=odbc_result($get_dates1, "Total Amount");
$Payble=odbc_result($get_dates1, "Net Payble");
    $data = array(
    		array("Invoice No" => "$Invoice","Amount" => "$Amount","Payble" => "$Payble")
