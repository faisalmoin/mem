 ...
 <link href='https://fonts.googleapis.com/css?family=Raleway' rel='stylesheet' type='text/css'>
		    ...
		    <table class="table table-responsive" style="border: 1px solid #d3d3d3;">
                ...
                <table class="table table-responsive " border="1" width="100%" id="abc" class="table table-fixed">
                        ...
                        <tr>
				<td>Total</td>
				<td colspan="<?php echo 3+($c+$i)?>">
				<td colspan="<?php echo $i ?>"><?php echo number_format($G_Total,2,'.',''); ?></td>                                
                        </tr>
                        </tbody>
                </table>
        ...
        <!---------Genrated fee start----------->
                ...
                <table class="table table-responsive " border="1" width="100%" id="abc" class="table table-fixed">
                        ...
                        <tr style="background-color: #FFC088;" class="statetablerow">
                            ...
                            <th rowspan="2" style="text-align: center;" >Total Student</th>
                            <?php echo $td; ?>
                            <th colspan="2" style="text-align: center;">Generated Total</th>
                        </tr>
                        </thead>
                        <tbody>
				...
				<td colspan="<?php echo $i ?>"></td>
                               <td colspan="<?php echo $i ?>" style="text-align: right;"><?php echo number_format($G_Total1,2,'.',''); ?></td>
                               </tr>
                        </tbody>
                </table>
                         ...
                         <?php
                                ...
                                while(odbc_fetch_array($FeeHead2)){
                                        ...
                                        if(odbc_num_rows($Check_Fee2) != 0){
                                           ...
                                           $Pay1 = odbc_exec($conn, "select sum([Amount Paid]) from [Ledger Payment] WHERE [Fee Description] LIKE 'Net ".ucwords(strtolower(odbc_result($Check_Fee2, "Fee Description")))." payable' AND [Customer No] IN (SELECT [System Genrated No_] FROM [Temp Application] WHERE [Company Name]='".odbc_result($rs, "ID")."' AND [Class]='".odbc_result($rs1, "Code")."') AND [Company Name]='".odbc_result($rs, "ID")."' ");
					   //   $Pay1 = odbc_exec($conn, "select sum([Amount Paid]) from [Ledger Payment] WHERE [FinYr]='$FinYr' AND [Fee Description] LIKE 'Net ".ucwords(strtolower(odbc_result($Check_Fee2, "Fee Description")))." payable' AND [Customer No] IN (SELECT [System Genrated No_] FROM [Temp Application] WHERE [Company Name]='".odbc_result($rs, "ID")."' AND [Class]='".odbc_result($rs1, "Code")."') AND [Company Name] ='".odbc_result($rs, "ID")."'");
                        ...
                        ?>
                        <td colspan="<?php echo $j ?>" style='text-align: right;'>
                        ...
                        ?>
                        <tr><td>Total</td>
                                <td><input type="hidden" name="rCount" value="<?php echo ($i-1); ?>" />
                                <input type="hidden" name="cCount" value="<?php echo ($j-1); ?>" /></td>
                                <td colspan="<?php echo $i ?>" style="text-align: right;"><?php echo number_format($G_Total2,2,'.',''); ?></td>
                        </tr>
                        </tbody>
                </table>
        </td>
	    ...
	    <tr>
              ...
              <td><select name="Generate" id="Generate" class="form-control" style="width: 180px;padding: 8px;" >                  
                  <option value="">Select</option>
		...
		<tr><td><strong>Total Amount</strong></td><td><input style="width: 180px;padding: 8px;" type="text" class="form-control" name="totalamount" id="totalamount" value="<?php echo $G_Total;?>" /></td></tr>
		<tr><td><strong>Royalty Percentage</strong></td><td><input style="width: 180px;padding: 8px;" type="text" class="form-control" name="perRoyalty" id="perRoyalty" value="<?php echo odbc_result($Agreement, "Royaly %");?>"/></td></tr>
		<tr><td><strong>Total Royalty</strong></td><td><input style="width: 180px;padding: 8px;" type="text" class="form-control" name="totalRoyalty" id="totalRoyalty" value="<?php echo $G_Total*odbc_result($Agreement, "Royaly %")/100;?>" /><!--p style="color: red;">(<--?php echo odbc_result($Agreement, "Royaly %");?>% Royalty Amount)</p--></td></tr>
		<tr><td><strong>Invoice Amount</td></strong><td><input style="width: 180px;padding: 8px;" type="text" class="form-control" class="number-only" name="feeamount" id="invAmount" value="" required/></td></tr>
		<tr><td><strong>Discount %</strong></td><td><input style="width: 180px;padding: 8px;" type="text" class="form-control" class="number-only" name="discount" id="discount" value="" /></td></tr>
                <tr><td><strong>Discount Description</strong></td><td><input style="width: 180px;padding: 8px;" type="text" class="form-control" class="number-only" name="discountdiscription" id="discountdiscription" value=""/></td></tr>
                <tr><td><strong>Discounted Invoice Amount</strong></td><td><input style="width: 180px;padding: 8px;" type="text" class="form-control" class="number-only" name="invoicediscount" id="invoicediscount" value=""/></td></tr>
		...
		<tr><td><strong>Taxable Amount</strong> </td><td><input style="width: 180px;padding: 8px;" type="text" class="form-control" name="servisetax" id="servicetax" value="" class="number-only" required/></td></tr>
		<tr><td><strong>Net Payble</strong></td><td><input style="width: 180px;padding: 8px;" type="text" class="form-control" name="payble" id="payble" value="" class="number-only" required/></td></tr>
