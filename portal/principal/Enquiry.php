...
<div class="x_content">
	...
	<thead>
		...
		<tr>
			...
			?>
			<td><a href="ListEnquiry.php?y=<?php echo odbc_result($Enq, 'report_year')?>&m=<?php echo $i?>"><?php echo odbc_result($Count, '');?></a></td>
			<?php
				}
			?>
			<td><?php 
				...
				echo "<a href='ListEnquiry.php?y=".odbc_result($Enq, 'report_year')."'>".odbc_result($TotCount, '')."</a>";
			?></td>
		</tr>
		<?php
			}
