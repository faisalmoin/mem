    ...
    <div id="myTabContent" class="tab-content">
        ...
        <div class="tab-pane fade in active" id="active">
            ...
            <table class="table table-responsive">
                ...
                <?php
                    $i=1;
                    $stu2=odbc_exec($conn, "SELECT [No_], [Name], [Academic Year], [Class], [Section], [Date Of Birth], [Gender], [Addressee], [Mobile Number] FROM [Temp Student] WHERE [Student Status]=1 AND [Company Name]='$ms' ORDER BY [Academic Year], [Class], [Section]") or die(odbc_errormsg($conn));
        ...
        <div class="tab-pane fade in" id="inactive">
            ...
            <table class="table table-responsive">
                ...
                <?php
                    $i=1;
                    $stu3=odbc_exec($conn, "SELECT [No_], [Name], [Academic Year], [Class], [Section], [Addressee], [Mobile Number],[Withdrwal Applied Date] FROM [Temp Student] WHERE [Student Status]=3 AND [Company Name]='$ms' ORDER BY [Class], [Section]") or die(odbc_errormsg($conn));
        ...
        <div class="tab-pane fade in" id="alumni">
            ...
            <table class="table table-responsive">
                ...
                <?php
                    $i=1;
                    $stu=odbc_exec($conn, "SELECT [No_], [Name], [Academic Year], [Class], [Section], [Addressee], [Mobile Number],[Withdrwal Applied Date] FROM [Temp Student] WHERE [Student Status]=2 AND [Company Name]='$ms' ORDER BY [Class], [Section]") or die(odbc_errormsg($conn));
