                    ...
                    <div class="tab-content">
                        <div class="tab-pane active" id="myModal<?php echo $i?>tab1">
                            <div class="table-responsive">
                                ...
                                <tr>
                                    ...
                                    <td height="50px" style="font-weight: bold;"><?php  echo odbc_result($result, "Curriculum Interested") ?></td>
                                </tr>
                                <tr>
                                    <td>Mother's Name</td>
                                ...
                                <tr>
                                    ...
                                    <td colspan="5" style="font-weight: bold;"><?
                                        ...
                                        if(odbc_result($result, "Language 2")==3) echo "Sanskrit";
                                        if(odbc_result($result, "Language 2")==4) echo "Kannada";
                                        ?></td>
                                </tr>
                                <tr>
                        ...
                        <div class="tab-pane" id="myModal<?php echo $i?>tab3">
                            <div class="table-responsive">
                                ...
                                <tr>
                                    <td>Qualification</td>
                                    <td style="font-weight: bold;"><?php echo odbc_result($result, "Gaurdian Qualification")?></td>
                                    <td>Office Address 1</td>
                                    <td style="font-weight: bold;"><?php echo odbc_result($result, "Gaurdian Office Address 1")?></td>
                                </tr>
                                <tr>
                                    <td>Occupation</td>
                                    <td style="font-weight: bold;"><?php echo odbc_result($result, "Gaurdian Occupation")?></td>
                                    <td>Office Address 2</td>
                                    <td style="font-weight: bold;"><?php echo odbc_result($result, "Gaurdian Office Address 2")?></td>
                                </tr>
                                <tr>
                                    <td>Annual Income</td>
                                    <td style="font-weight: bold;"><?php echo number_format((float)odbc_result($result, "Gaurdian Annual Income"),2, '.', '') ?></td>
                                    <td>Office Post Code</td>
                                    <td style="font-weight: bold;"><?php echo odbc_result($result, "Gaurdian Office Post Code")?></td>
                                </tr>
                                <tr>
                                    <td>Office City</td>
                                    <td style="font-weight: bold;"><?php echo odbc_result($result, "Gaurdian Office City")?></td>
                                    <td>Office Country</td>
                                    <td style="font-weight: bold;"><?php echo odbc_result($result, "Gaurdian Office Country Code")?></td>
                                </tr>
                                </table>
                            </div>
                        </div>
                        <div class="tab-pane" id="myModal<?php echo $i?>tab4">
                            <div class="table-responsive">
                                ...
                                <tr>
                                    ...
                                    <td colspan="3" style="font-weight: bold;"><?php echo odbc_result($result, "Remarks")?></td>
                                </tr>
                                </table>
                            </div>
                        </div>
