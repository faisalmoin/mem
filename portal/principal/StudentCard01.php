...
?>
    <table class='table table-responsive'>
        <tr>
            ...
            <td>EWS</td>
            <td><input type='checkbox' name='EWS' value='<?php if(odbc_result($row, "EWS")==1) echo " checked"?>' disabled="true"></td>
        </tr>
        <tr>
            <td>Student Name</td>
        ...
        <tr>
            ...
            <td>Balance LCY</td>
            <td><input type="text" name='BalanceLCY' style="text-align: right;" value="<?php echo number_format(odbc_result($Bal, ""),'2','.',''); ?>"" readonly="true" class="form-control" ></td>
            <td></td>
            <td></td>
        </tr>
        <tr>
