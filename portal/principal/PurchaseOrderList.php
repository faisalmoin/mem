...
<div class="x_panel">
<div class="x_title">
<h2>Purchase Order List </h2> <!-- Page Name -->
...
<tr>
<td><?php echo $i; ?></td>
<td><a href="PurchaseOrderListView.php?ID=<?php echo odbc_result($result, "ID")?>" class="text-primary"><?php echo odbc_result($result,"PO No") ?></a></td>
