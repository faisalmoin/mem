...
$sql = odbc_exec($conn, "SELECT * FROM [Ledger Credit] WHERE [Company Name]='$ms' ORDER BY [Invoice Date] ASC ") or die(odbc_errormsg($conn));
//echo "SELECT * FROM [Ledger Credit] WHERE [Company Name]='$ms' ORDER BY [Invoice Date] ASC ";
...
<?php 
	while($curnm = odbc_fetch_array($sql_query)){
		print $curnm['ID']." - ".$curnm['Description']."<br>";
	}
