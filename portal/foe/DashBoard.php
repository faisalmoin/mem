            ...
            <div class="col-md-3 col-sm-12 col-xs-12">
                        ...
                        <table class="table table-striped" >
                            ...
                            while(odbc_fetch_array($EnqStat)){
                                ...
                                <tr>
                                    <td><?php
                                        if(odbc_result($EnqStat, "Enquiry Status")==0) echo "Hot";// 
                                        if(odbc_result($EnqStat, "Enquiry Status")==1) echo "COld"; // 
                                        if(odbc_result($EnqStat, "Enquiry Status")==2) echo "Warm"; //Warm
                                        ?>
                                    </td>
                                    <td align="center">
                                        <?php
